									...
									<div class="card-body">
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="text" class="form-control" name="subcategory_name" value="{{$edit_subcategory->subcategory_name}}" >
											</div>
										</div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <select class="single-select form-control" name="category_id" >
                                                ...
                                                <option value="{{ $cat->id }}" {{ $cat->id == $edit_subcategory->category_id ? 'selected' : '' }}>{{ $cat->category_name}}</option>
                                                @endforeach
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <img id="showImage" src="{{ asset($edit_subcategory->subcategory_image) }}" class="rounded-circle p-1 border" width="90" height="90" alt="Avatar">
                                            </div>
                                        </div>
										<div class="row">
