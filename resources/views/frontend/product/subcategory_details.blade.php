                ...
                <div class="row align-items-center">
                    <div class="col-xl-3">
                        ...
                        <div class="breadcrumb">
                            ...
                            <span></span> <a href="{{ url('product/category/'.$breadsubcat->category->id.'/'.$breadsubcat->category->category_slug) }}">{{$breadsubcat->category->category_name}}</a> <span></span> {{$breadsubcat->subcategory_name}}
                        </div>
                    </div>
