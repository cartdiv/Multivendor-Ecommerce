    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                ...
                <span></span> Store <span></span> {{$vendors->name}}
            </div>
        </div>
    </div>
    <div class="container mb-30">
        <div class="archive-header-2 text-center pt-80 pb-50">
            <h1 class="display-2 mb-50">{{$vendors->name}}</h1>
            ...
            <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
                <div class="sidebar-widget widget-store-info mb-30 bg-3 border-0">
                    <div class="vendor-logo mb-30">
                        <img src="{{ (!empty($vendors->photo)) ? url('upload/vendor_image/'.$vendors->photo):url('upload/no_image.jpg') }}" alt="" />
                    </div>
                    <div class="vendor-info">
                       @if ($vendors->created_at == NUll )      
                        <div class="product-category">
                            <span class="text-muted">Since {{ date("Y", strtotime($vendors->updated_at)) }}</span>
                        </div>
                        @else
                        <div class="product-category">
                            <span class="text-muted">Since {{ date("Y", strtotime($vendors->created_at)) }}</span>
                        </div>
                        @endif

                        <h4 class="mb-5"><a href="vendor-details-1.html" class="text-heading">{{$vendors->name}}</a></h4>
                        ...
                        <div class="vendor-des mb-30">
                            <p class="font-sm text-heading">{{$vendors->vendor_short_info}}</p>
                        </div>
                        ...
                        <div class="vendor-info">
                            <ul class="font-sm mb-20">
                                <li><img class="mr-5" src="assets/imgs/theme/icons/icon-location.svg" alt="" /><strong>Address: </strong> <span>{{$vendors->address}}</span></li>
                                <li><img class="mr-5" src="assets/imgs/theme/icons/icon-contact.svg" alt="" /><strong>Call Us:</strong><span>{{$vendors->phone}}</span></li>
                            </ul>
