...
@if ($status === 'active')
	<h4>Vendor Accout is <span class="text-success">Active</span> </h4>
	@else
	<h4>Vendor Accout is <span class="text-danger">InActive</span> </h4>
	<p class="text-danger"><b>Please wait for the admin to approve your account thank you.<b></p>
@endif
