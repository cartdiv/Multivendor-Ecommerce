    ...
    <div class="page-content">
      ...
      <div class="card">
          <div class="card-body p-4">
              ...
              <hr/>
              <form id="myForm" method="post" action="{{ route('store.vendor.product') }}" enctype="multipart/form-data" >
                @csrf
                ...
                <div class="row">
                   ...
                   <div class="border border-3 p-4 rounded">
                    <div class="mb-3">
                      ...
                      <input type="text" name="product_tags" class="form-control" data-role="tagsinput" value="new product,product">
                    </div>

                    <div class="mb-3">
                        <label for="inputProductTitle" class="form-label">Product size</label>
                        <input type="text" name="product_size" class="form-control" data-role="tagsinput" value="Small,Midiume,Large">
                      </div>

                      <div class="mb-3">
                        <label for="inputProductTitle" class="form-label">Product Color</label>
                        <input type="text" name="product_color" class="form-control" data-role="tagsinput" value="Red,Black">
                      </div>
                      ...
                      <div class="mb-3">
                        ...
                        <textarea name="long_descp" id="mytextarea">Hello, World!</textarea>
                      </div>
                    ...
                    <div class="border border-3 p-4 rounded">
                      <div class="row g-3">
                        <div class="form-group col-md-6">
                          ...
                          <div class="form-group col-md-6">
                            <label for="inputStarPoints" class="form-label">Product Qantity</label>
