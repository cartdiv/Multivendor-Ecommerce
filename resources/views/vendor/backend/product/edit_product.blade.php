...
<form id="myForm" method="post" action="{{ route('update.vendor.product') }}" enctype="multipart/form-data" >
			@csrf
...
<div class="page-content">
	...
	<hr>
<div class="card">
<form method="post" action="{{ route('update.vendor.product.thambnail') }}" enctype="multipart/form-data" >
			@csrf
