...
class ShippingAreaController extends Controller
{
    public function AllDivision(){
        ...
        return view('admin.backend.ship.division.division_all',compact('division'));
    } // End Method 

    public function AddDivision(){
        return view('admin.backend.ship.division.division_add');
    }// End Method 
    ...
    public function EditDivision($id){
        ...
        return view('admin.backend.ship.division.division_edit',compact('division'));
    ...
    public function DeleteDivision($id){
     ...
     public function AllDistrict(){
        ...
        return view('admin.backend.ship.district.district_all',compact('district'));
    } // End Method 

    public function AddDistrict(){
        $division = ShipDivision::orderBy('division_name','ASC')->get();
        return view('admin.backend.ship.district.district_add',compact('division'));
    }// End Method 
...
public function StoreDistrict(Request $request){ 
    ...
    public function EditDistrict($id){
        ...
        return view('admin.backend.ship.district.district_edit',compact('district','division'));
    ...
    public function UpdateDistrict(Request $request){
     ...
     public function AllState(){
        ...
        return view('admin.backend.ship.state.state_all',compact('state'));
    } // End Method 
    ...
    public function AddState(){
        ...
        $district = ShipDistricts::orderBy('district_name','ASC')->get();
         return view('admin.backend.ship.state.state_add',compact('division','district'));
    }// End Method 
    ...
    public function EditState($id){
        ...
        $state = ShipState::findOrFail($id);
         return view('admin.backend.ship.state.state_edit',compact('division','district','state'));
    }// End Method 
